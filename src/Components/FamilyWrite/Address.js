...
import { SignUpInput, SubjectText, ErrorMessage } from '../SignUp/SignUpLayout'
  ...
  return (
    <>
      <AddressDiv
        ...
        error={props.error}
      >
        <SubjectText style={{ marginRight: '18px' }}>주소</SubjectText>
        <SignUpInput
          width={'400px'}
          readOnly={true}
          ...
          value={props.address}
        />
        <SearchIcon style={{ marginLeft: '80px' }} onClick={toggle} />
        {modal ? (
          <DaumPostcode
